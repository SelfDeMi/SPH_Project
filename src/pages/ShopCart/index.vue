  ...
  <div class="cart">
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isAllChecked&&cartInfoList.length>0" @change="updateAll">
        <span>全选</span>
      </div>
      <div class="option">
  ...
  export default {
    ...
    methods: {
        ...
        async deleteCartById(cart){
          try {
            await this.$store.dispatch('shopcart/deletCartListBySkuId',cart.skuId)
            console.log("刷新");
            this.getData()
          } catch (error) {
            console.log("失败");
